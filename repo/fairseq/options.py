...
def get_eval_ctg_lm_parser(default_task="ctg_language_modeling"):
    parser = get_parser("Evaluate Language Model", default_task)
    add_dataset_args(parser, gen=True)
    add_eval_lm_args(parser)
    add_model_args(parser) # my
    return parser
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if gen:
        ...
        group.add_argument('--gpt2-gen-mode', action='store_true',help='True when we generate sents with gpt2 models')
    # fmt: on
    return group
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--gpt2-padding', action='store_true',help='use DIY padding token 50257') #my
    group.add_argument('--gpt2-gen-mode', action='store_true',help='use DIY padding token 50257') #my
    # fmt: on
    return group
...
def add_eval_lm_args(parser):
    ...
    group.add_argument('--save-condition-sent-ids', action='store_true',
                       help='save sentence ids for condition retrieval')
    group.add_argument('--sentiment-control', action='store_true',
                       help='use sent ids for condition retrieval')    #my
    group.add_argument('--topic-control', action='store_true',
                       help='use sent ids for condition retrieval')
    group.add_argument('--similar-condition-prob', default=0.9, type=float)
    group.add_argument('--gpt2-padding', action='store_true',help='use DIY padding token 50257')
    group.add_argument('--condition-embed-dim', type=int,default=0,help='dim of condition vectors')
    group.add_argument('--classifier-path', default="../models/classifier/best_model.pt",help='dim of condition vectors')
...
def add_generation_args(parser):
    ...
    group.add_argument('--knnlm', action='store_true',help='use the k-nearest neighbors language model')
    group.add_argument('--gpt2-padding', action='store_true',help='use DIY padding token 50257')
    group.add_argument('--sentiment-control', action='store_true',help='use sent ids for condition retrieval')
    group.add_argument('--topic-control', action='store_true',help='use sent ids for condition retrieval')
    group.add_argument('--refine', action='store_true',help='use classifier to refine generated tokens')
    group.add_argument('--similar-condition-prob', default=0.9, type=str)
    group.add_argument('--delta', default=0.4, type=float)
    group.add_argument('--prompt-control-code', default=None, type=str)
    group.add_argument('--classifier-path', default=None, type=str)
    group.add_argument('--pretrained-model-path', default=None, type=str)
    group.add_argument('--max-control-step', default=80, type=int)
    group.add_argument('--min-lmbda', default=0.4, type=float)
