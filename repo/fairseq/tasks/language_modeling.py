    ...
    def load_dataset(self, split, epoch=0, combine=False, **kwargs):
        ...
        if self.args.gpt2_padding: # my
            ...
            dataset = TokenBlockDataset(
                ...
                gpt2_gen_mode=self.args.gpt2_gen_mode,
            )
        else:
            dataset = TokenBlockDataset(
                dataset,
        ...
        self.datasets[split] = MonolingualDataset(
            ...
            shuffle=False if hasattr(self.args, 'lm_eval') and self.args.lm_eval or hasattr(self.args, 'optimizer') and self.args.optimizer!="nag" else True,
    ...
    def inference_step(self, generator, models, sample, prefix_tokens=None):
        with torch.no_grad():
            ...
            if prefix_tokens is None and sample["net_input"]["src_tokens"].nelement():
                if self.args.gpt2_gen_mode:
                    prefix_tokens = sample["net_input"]["src_tokens"][:, 1:]
                else:
                    prefix_tokens = sample["net_input"]["src_tokens"] # my
